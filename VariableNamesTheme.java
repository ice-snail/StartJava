class VariableNamesTheme {
    public static void main(String [] args) {
        // Начало блока разные переменные
        ...
        // Вместимость
        double volume = 1.2;
        System.out.println("Вместимость = " + volume + " квадратных метра");
        ...
        System.out.println("Емкость жесткого диска - " + volumeHdd);
